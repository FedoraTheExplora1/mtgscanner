...
try:
    with open('C:\Users\conno\OneDrive\Documents\GitHub\mtgscanner\card_hashes.json', 'r') as f:
...
# Function to set the focus of the webcam
def set_focus(value):
...
cv2.namedWindow('MTG Card Scanner')

# Add a trackbar to adjust the focus
cv2.createTrackbar('Focus', 'MTG Card Scanner', 0, 100, set_focus)  # Adjust the maximum value as needed

card = None  # Ensure the card variable is defined
