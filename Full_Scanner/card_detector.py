...
class CardDetector:
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture(2)  # Ensure the correct camera index
    ...
    def detect_card(self):
        ...
        contours = [c for c in contours if cv2.contourArea(c) > 5000 and 0.7 < cv2.contourArea(c) / cv2.arcLength(c, True) < 1.3]
